...
export const getParty = async (req, res) => {
  const { CustomerID, Cguid, PartyName, Mobile1, Email1, Page, PageSize } = req.query;
  const sequelize = await dbConection();
